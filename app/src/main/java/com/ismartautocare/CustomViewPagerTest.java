...
public class CustomViewPagerTest extends ViewGroup {
    ...
    public CustomViewPagerTest(Context context) {
        super(context);
        initViewPager();
    }

    public CustomViewPagerTest(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
