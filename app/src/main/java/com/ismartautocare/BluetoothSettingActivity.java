...
public class BluetoothSettingActivity extends Activity implements View.OnClickListener {
    ...
    Button button = null;
    Button button_status = null;
    Button button_print = null;
    EditText editText_TextToPrint;
    byte[] texttoprint;
...
//                    new AlertDialog.Builder(me).setTitle(getString(R.string.error)).setMessage(R.string.is_not_supported_by_firmware_message).setPositiveButton("OK", new DialogInterface.OnClickListener() {
//                        public void onClick(DialogInterface dialog, int which) {
////                            finish();
//                        }
//                    }).setCancelable(false).show();
...
//            }
//        });
//        texttoprint = editText_TextToPrint.getText().toString().getBytes();
//
...
//
//        String strPrintArea = "2inch (58mm)";
//        int source = R.drawable.image1;
//        int paperWidth = 384; // 2inch (384 dot)
////        MiniPrinterFunctions.PrintBitmapImage(this, portName, portSettings, getResources(), source, paperWidth, false, false);
//        MiniPrinterFunctions.PrintBitmapImage(this, portName, portSettings, getResources(), source, paperWidth, false, false);
////        MiniPrinterFunctions.PrintSampleReceipt_Portuguese(me, portName,portSettings, strPrintArea);
////        MiniPrinterFunctions.PrintText(this, portName, portSettings, false, false, false, false, height,width, 0, PrinterFunctions.Alignment.Left, texttoprint);
//
//    }
//
...
//        editText_TextToPrint = (EditText) findViewById(R.id.editText_TextToPrint);
//
//    }
//
...
//
//            Log.d("Tag","iOSPortNameCapability : "+iOSPortNameCapability);
